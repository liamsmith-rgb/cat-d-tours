...
const riders = [
  ...
  },
  {
    ...
    bio: "Neil's brother and a man with vast mechanical knowledge. Dave is an incredible mechanic by trade — he sees a vehicle and knows it inside out. Worked on everything from rally cars to adventure bikes. Used to be a rally driver alongside Neil back in the day. He's lived up in Scotland and is currently based in the North West. A lovely man with a love for distance riding, good photographs, and exploring different parts of the world.",
